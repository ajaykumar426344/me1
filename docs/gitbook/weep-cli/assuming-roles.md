...
```bash
AWS_CONTAINER_CREDENTIALS_FULL_URI=http://35.213.148.83:9091/ecs/consoleme_oss_1?assume=arn:aws:iam::123456789012:role/otherRole,arn:aws:iam::123456789012:role/andAnother aws sts get-caller-identity
{
